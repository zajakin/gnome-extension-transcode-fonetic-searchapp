...
Gnome-shell extension making apps search in launcher layout-idependent Simply install, enable and try to search app like 'ашду' - file-roller appears in search result.
