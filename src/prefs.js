...
export default class TranscodeAppSearchPreferences extends ExtensionPreferences {
  fillPreferencesWindow(window) {
    ...
    const page = new Adw.PreferencesPage({
      title: _("Transliteration Settings"),
      icon_name: "document-properties-symbolic",
    });

    const transliterationGroup = new Adw.PreferencesGroup({
      title: _("Transliteration Methods"),
      description: _("Enable or disable different transliteration methods"),
    });
    ...
    const cyrillicToLatinRow = new Adw.ActionRow({
      title: _("Cyrillic to Latin"),
      subtitle: _("Search 'Учеу' to find 'Extensions'"),
    ...
    const latinToCyrillicRow = new Adw.ActionRow({
      title: _("Latin to Cyrillic"),
      subtitle: _("Search 'Hfcib' to find 'Расширения'"),
    ...
    const phoneticLayoutRow = new Adw.ActionRow({
      title: _("Phonetic Layout"),
      subtitle:
        _("Support phonetic: 'Ras[i' to find 'Расширения' and 'Еьтен' to find 'Extensions'"),
